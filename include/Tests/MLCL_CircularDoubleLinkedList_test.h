...
#ifndef MYLITTLECLIBRARY_MLCL_CIRCULARDOUBLELINKEDLIST_TEST_H
#define MYLITTLECLIBRARY_MLCL_CIRCULARDOUBLELINKEDLIST_TEST_H
...
#endif /* MYLITTLECLIBRARY_MLCL_CIRCULARDOUBLELINKEDLIST_TEST_H */
